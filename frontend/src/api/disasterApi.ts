...
export async function getMissions() {
  try {
    ...
    return [
      { id: 'MISSION-DRONE-001', droneId: 'DRONE-001', targetArea: 'Sector 12 & Riverbend Embankment', status: 'Active', batteryPct: 84, altitudeM: 120, speedKmh: 45, latitude: 28.6139, longitude: 77.2090, signalQuality: 92, flightMode: 'AUTONOMOUS RECON' },
      { id: 'MISSION-DRONE-002', droneId: 'DRONE-002', targetArea: 'Sector 14 Grid', status: 'Standby', batteryPct: 98, altitudeM: 0, speedKmh: 0, latitude: 28.6180, longitude: 77.2150, signalQuality: 98, flightMode: 'READY FOR DISPATCH' },
    ];
  }
}
